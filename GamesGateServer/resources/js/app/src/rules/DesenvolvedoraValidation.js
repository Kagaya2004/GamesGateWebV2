...
import { ERROR_DESENVOLVEDORA, DESENVOLVEDORA } from "../types/Desenvolvedora";
...
const desenvolvedoraValidationRules  =  {
    nome:(nome)=>{
        let mensagens = [];
        if (!nome || nome.trim().length === 0 ) {
           mensagens.push('Obrigatório informar o nome da desenvolvedora');
        }
        return mensagens;
    },
...
export const useValidarDadosDesenvolvedora = () => {
    return useValidator(DESENVOLVEDORA, ERROR_DESENVOLVEDORA, desenvolvedoraValidationRules);
}
